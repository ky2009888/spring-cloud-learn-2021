package com.ky.apps.service.utils;
...
public class JasyptUtil {
    ...
    public static void main(String[] a) throws Exception {
        String input = "jliang83";
        String key = "Qwer@#1234";
        String result = JasyptUtil.encryption(input, key);
        log.info(result);
        log.info(JasyptUtil.decryption(result, key));
    }
