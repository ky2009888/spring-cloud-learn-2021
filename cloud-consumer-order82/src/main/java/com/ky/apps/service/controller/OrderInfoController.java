...
public class OrderInfoController {
     ...
     */
    public static final String HTTP_PAYMENT_URL_SERVICE = "http://spring-cloud-provider-payment-8004";
    /**
     * 自动注入RestTemplate.
     */
    @Resource
    private RestTemplate restTemplateZ;
    ...
    public String showOrder(long id) {
        ...
        CommonResult commonResult = restTemplateZ.getForEntity(queryPaymentByIdUrl, CommonResult.class, id).getBody();
        String resultStr = "";
    ...
    public CommonResult<Payment> payOrder() {
        ...
        CommonResult<Payment> commonResult = restTemplateZ.postForObject(queryPaymentCreateUrl, payment, CommonResult.class);
        String resultStr = "";
        if (commonResult != null && commonResult.getData() != null) {
            resultStr = commonResult.getData().toString();
            log.info("{}", resultStr);
